...
const PaperSubmissionpage = () => {
    return (
        <div className="container max-w-full px-4 mx-auto font-['Roboto']">
            ...
            <div className="my-8">
                <h2 className="text-xl font-bold text-gray-900 mb-4">INSTRUCTION TO AUTHORS</h2>
                <p className="text-gray-700 text-lg leading-relaxed">
                    Authors are invited to submit original, unpublished research papers for presentation at the
                    International Conference on Optical Communication, Photonics, Telecommunications, and Intelligent
                    Machine Applications (OPTIMA 2025).
                </p>
            </div>
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                    The International Conference on Optical Communication, Photonics, Telecommunications, and
                    Intelligent Machine Applications (OPTIMA 2025) invites authors to submit original, high-quality
                    research papers through the Microsoft CMT (Conference Management Toolkit) system.
                </p>
            </div>
            ...
            <div className="mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Important Dates for OPTIMA 2025</h3>
            ...
            <div className="p-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Publication and Indexing</h2>
                <ul className="space-y-3">
                    {[
