...
const hotels = [
  ...
  },
  {
    ...
    location: "Tashkent, Uzbekistan",
    image: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/200020233.jpg?k=6b5115901278fbda04368b68a99e16ab46318a9668bedcf52e3348b30bee7d56&o=&hp=1",
  },
];
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {hotels.map((hotel, index) => (
              ...
              >
                ...
                />
                <div className="p-4">
                  <Link to={hotel.link} className="text-xl font-bold text-gray-800 hover:underline">
                    {hotel.name}
                  </Link>
